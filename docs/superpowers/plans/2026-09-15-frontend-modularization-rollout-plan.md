...
**Current status — 2026-09-20:** draft PR #54 is open from the exact post-C9 base `2b5060c8293fec6756b286627212b740b3147e53`. The C10 design is **APPROVED** and establishes frontend `src/shared/{ui,hooks,utils}`, closes residual generic roots by real ownership, removes the final API facade/migration allowlist, and adds generic domain-purity/cycle gates. The detailed implementation plan was **APPROVED explicitly by the user on 2026-09-20**. Tasks 1–2 are **COMPLETE / GREEN**. Task 1 baseline `264399e14ad82833c93143bd262c0018bd17376e` passed Validate #1519. Task 2 RED `a3618a4a92d3152dfb3486dfab94374a21ee974a` failed for the four intended final-API ownership gaps; GREEN `9dc095ad235ddcf10074058e42b5a49d76323dab` passed Validate #1522 with **1,913 tests / 1,912 pass / 0 fail / 1 skipped** and all gates green. The final `src/api/client.js` / `effectiveConfigClient.js` production facade is physically removed; Task 3 has not started.
