...
- Active slice: **C9 — Printing and QZ separation**, branch `feature/spec-c9-printing`, base `master` `91fb5581cea1616f438c13dfac28cfb38345fa59`, draft PR #53. Design/plan approved; **Tasks 1–6 COMPLETE / GREEN**. Task 6 GREEN `a02b9af0612353e445bf3997095da18bff2e5118` passed Validate #1492 / run `35482900556` with **1,876 tests / 1,875 pass / 0 fail / 1 skipped** and all gates green. Printing policy + Settings UI/CSS now belong to Printing; Task 7 is next/not started. Staging, physical QA, merge and production have not occurred.
...
**Current status — 2026-09-19:** **TASKS 1–6 COMPLETE / GREEN; Task 7 NOT STARTED** on draft PR #53, branch `feature/spec-c9-printing`. Task 6 GREEN `a02b9af0612353e445bf3997095da18bff2e5118` passed Validate #1492 / run `35482900556` with **1,876 tests / 1,875 pass / 0 fail / 1 skipped** and all remaining gates green. Printing API ownership, QZ infrastructure, application manager, PrintQueue, Printing policies and Settings UI/CSS are extracted. Remaining temporary C9 facades are explicitly ledgered for App/browser/legacy-wrapper cleanup in Tasks 7–8; the stale direct-QZ allowlist entry is removed in Task 9. No staging or production deploy has occurred.
