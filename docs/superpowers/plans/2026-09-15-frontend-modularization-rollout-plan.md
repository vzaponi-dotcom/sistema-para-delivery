...
- `getTableTabDetail` now belongs to `domains/table-service/infrastructure/tableServiceApi.js`; the four table-management/transfer commands remain temporarily in `src/api/client.js` until Task 5. Payment/printing endpoints remain deferred to C6/C9.
