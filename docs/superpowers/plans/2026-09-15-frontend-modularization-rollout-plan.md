...
**Current status — 2026-09-19:** design and implementation plan are **APPROVED**; draft PR #52 is open. **Tasks 1–5 are COMPLETE / GREEN**. Task 2 moved product API/commands to Catalog and introduced official `deletedProductId`; Task 3 isolated administrative list projection; Task 4 moved draft/editor/dialog ownership; Task 5 introduced stable `CatalogWorkspace` composition and removed temporary public exports/App product composition. Latest GREEN: `ca26a0f48527a0e8f5371655bec0cc6c59b3a951`, Validate #1453 / run `35467142766`, **1,852 tests / 1,851 pass / 0 fail / 1 skipped**, all workflow gates green. The product caller of `updateCollection` is gone, but the generic runtime escape hatch remains physically present for Task 6 removal. No staging, merge or production deploy occurred.
