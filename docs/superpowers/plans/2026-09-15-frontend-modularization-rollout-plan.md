...
- Active slice: **C9 — Printing and QZ separation**, branch `feature/spec-c9-printing`, base `master` `91fb5581cea1616f438c13dfac28cfb38345fa59`, draft PR #53. Design/plan approved; **Tasks 1–7 COMPLETE / GREEN**. Task 7 final GREEN `7a0785ca454ecde0f0f18cce6f1370911c3edc63` passed Validate #1496 / run `35484090583` with **1,882 tests / 1,881 pass / 0 fail / 1 skipped** and all gates green. Printing now owns policies, Settings UI, PrintQueue and second-copy/recovery overlays; Task 8 is next/not started. Staging, physical QA, merge and production have not occurred.
...
**Current status — 2026-09-19:** **TASKS 1–7 COMPLETE / GREEN; Task 8 NOT STARTED** on draft PR #53, branch `feature/spec-c9-printing`. Task 7 final GREEN `7a0785ca454ecde0f0f18cce6f1370911c3edc63` passed Validate #1496 / run `35484090583` with **1,882 tests / 1,881 pass / 0 fail / 1 skipped** and all remaining gates green. Printing API ownership, QZ infrastructure, manager, PrintQueue, Printing policies/Settings and second-copy/recovery overlay ownership are extracted. App now only composes the public Printing overlays and delegates origin-order persistence through the manager. Remaining temporary legacy/browser facades are scheduled for Task 8; stale direct-QZ allowlist enforcement remains Task 9. No staging or production deploy has occurred.
