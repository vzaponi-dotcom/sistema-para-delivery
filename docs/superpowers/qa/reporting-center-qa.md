...
Rows 1–73 from the approved implementation plan are currently **PENDING**.

Task 1 has no staging deployment and therefore does not claim manual acceptance.
