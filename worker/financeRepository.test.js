...
test('movement mapper exposes finance metadata', () => {
  assert.deepEqual(mapMovementRow({
    ...
    source: 'order-payment', order_id: 'o1', payment_id: 'p1', receipt_id: 'r1', payment_allocation_id: 'a1', payment_method: 'Pix',
    ...
    source: 'order-payment', orderId: 'o1', paymentId: 'p1', receiptId: 'r1', paymentAllocationId: 'a1', paymentMethod: 'Pix',
