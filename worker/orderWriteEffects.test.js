        ...
        return {
          async first() {
            ...
            if (sql.includes('FROM table_tabs')) {
              ...
              return { id: 't1', table_identifier: '04', status: 'closed', opened_at: '2026-09-03T14:00:00.000Z', closed_at: '2026-09-03T15:00:00.000Z' }
            }
            return null
          },
        }
...
test('write-effect readers return mapped payment movement and current table tab', async () => {
  ...
  assert.deepEqual(movement, {
    ...
    source: 'order-payment', orderId: 'o1', paymentId: 'p1', movementDate: '2026-09-03', date: '2026-09-03', createdAt: '2026-09-03T15:00:00.000Z',
  })
  assert.deepEqual(tableTab, {
    id: 't1', tableIdentifier: '04', status: 'closed', openedAt: '2026-09-03T14:00:00.000Z', closedAt: '2026-09-03T15:00:00.000Z',
  })
})
