...
function ComandaDetail({ detail, currency, disabled = false, busyAction = false, printingDisabled = false, canTransfer = false, onAddOrder, onViewTicket, onPrint, onPay, onTransfer, labelledBy }) {
