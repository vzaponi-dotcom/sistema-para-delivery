...
function App({ capabilities } = {}) {
  ...
  return (
    ...
    >
      ...
      <AppShell businessId={sessionContext?.businessId} navigationBadges={{ orders: operationalOrderCount, comandas: openComandaCount }} onLogout={handleLogout} logoutDisabled={writesBlocked}>
