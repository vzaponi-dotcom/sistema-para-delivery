...
test('mobile composes overview, sales, operation and products from reporting API without a desktop table', async (t) => {
  ...
  const renderer = await harness.render(ReportingMobileSummary, { query: { view: 'detail', from: '2026-09-10', to: '2026-09-10' }, detailState: { data: { items: [{ id: 'o1', order_number: 1, client_name_snapshot: 'Ana', total_cents: 1000 }] } }, api })
