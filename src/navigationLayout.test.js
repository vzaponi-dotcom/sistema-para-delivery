...
test('uma única subnavegação precede o PageHeader nas áreas que mantêm subtabs', async (t) => {
  ...
  const [{ default: Orders }, { default: OrderHistory }, { default: Dashboard }, { default: Receivables }, { default: Finance }, { DashboardPeriodContext }] = await Promise.all([
    h.load('/src/domains/orders/ui/Orders.jsx'), h.load('/src/domains/orders/ui/OrderHistory.jsx'), h.load('/src/pages/Dashboard.jsx'), h.load('/src/pages/Receivables.jsx'), h.load('/src/domains/finance/ui/Finance.jsx'), h.load('/src/components/dashboardPeriodContext.js'),
  ])
